...
namespace Modulo6.Script
{
    public class CrearCubo : MonoBehaviour
    {
        ...
        void Start()
        {
            objToSpawn = new GameObject("Mi primer cubo"); // Object to spawn es como aparecer objeto 
            ...
            meshRendererMaterial.color = Color.cyan; //agregamos color
            objToSpawn.transform.position = new Vector3(10,10,10); //movemos posicion de cubo
